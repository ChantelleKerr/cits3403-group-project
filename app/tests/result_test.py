...
class ResultModelTest(unittest.TestCase):
  ...
  # The test queries for the results with ids of 200 and 201
  # The test passes if the first query returns a status code of 200
  # and the second query returns a status code of 404
  # Lastly, the data from the first query must match the information
  # specified below
  ...
  # The test queries for the results that have user_ids of 2000 and 2001
  # The test passes if both queries return a status code of 200
  # Also, the data from the queries must match the information
  # specified below
  ...
  # The test passes if the first write produces a 201 status code
  # and the second write produces a 200 status code
  ...
  # and the response data matches with the dictionary specified below
